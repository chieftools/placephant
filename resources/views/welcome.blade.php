<x-layout>
    ...
    <div id="placephant">
        <h1 class="text-blueaccent text-4xl mb-2">
            <a href="#placephant">#</a> Placephant
        </h1>
        <p>
            Add simple placeholder with images of the different <a href="https://www.php.net/elephpant.php" target="_blank">ElePHPants</a>.
            You can use the placeholders while developing a new website till you have the needed images.
        </p>
    </div>

    <div id="usage" class="mt-8">
        ...
        <p>
            For more information about the different options and examples check the <a href="{{ route('options') }}">options page</a>.
        </p>
    </div>
