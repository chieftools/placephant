<x-layout>
    ...
    <div id="options">
        <h1 class="text-blueaccent text-4xl mb-2">
            <a href="#options">#</a> Options with examples
        </h1>
        <p>
            See the <a href="#usage">basic usage</a> with the <a href="#filters">filters</a>, <a href="#fit">fit</a>, <a href="#name">name</a> options to define a specific image, format and style.
            And <a href="#examples">examples</a> to get to know all the options that can make you creative in using placephant.
        </p>
    </div>
    ...
    <div class="mt-8" id="usage">
        ...
        <p>
            ...
            <x-codeline>&lt;img src="//placephant.com/300/250"/&gt;</x-codeline>
            <br>
            If you want a square image you can use one size.
            <x-codeline>&lt;img src="//placephant.com/300"/&gt;</x-codeline>
            <br>
        </p>
        <p>
            It is possible to use 0 for one of the sizes, this will result in an image that keeps the original ratio.
            The maximum size that you can use is a width of {{ $config['max_width'] ?? '??' }} and a height of {{ $config['max_height'] ?? '??' }} any size above that will be set to the maximum.
        </p>
        ...
        <div id="filters" class="mt-4">
            ...
            <p>
                You can add a query parameter to use a filter:
                <x-codeline>&lt;img src="//placephant.com/300/250?filter=greyscale"/&gt;</x-codeline>
                , or you can add it as first part before the sizes:
                <x-codeline>&lt;img src="//placephant.com/greyscale/300/250"/&gt;</x-codeline>
            </p>
        </div>

        <div id="fit" class="mt-4">
            ...
            <p>
                You can add the fit as a query parameter:
                <x-codeline>&lt;img src="//placephant.com/300/250?fit=max"/&gt;</x-codeline>
                .
            </p>
        </div>
        ...
        <div id="name" class="mt-4">
            ...
            <p>
                You can add the name as a query parameter:
                <x-codeline>&lt;img src="//placephant.com/300/250?name={{ $imagelist->keys()->first() }}"/&gt;</x-codeline>
                .
            </p>
        </div>
    </div>
    ...
    <div id="examples" class="mt-10">
        ...
        <div class="flex flex-col md:flex-row mt-2">
            ...
            <div class="basis-full md:basis-1/2 mx-2">
                <ol>
                    <li>1.
                        <x-codeline>&lt;img src="//placephant.com/greyscale/100"/&gt;</x-codeline>
                        .
                    </li>
                    <li>2.
                        <x-codeline>&lt;img src="//placephant.com/greyscale/100/100"/&gt;</x-codeline>
                        .
                    </li>
                    <li>3.
                        <x-codeline>&lt;img src="//placephant.com/100?filter=greyscale"/&gt;</x-codeline>
                        .
                    </li>
                    <li>4.
                        <x-codeline>&lt;img src="//placephant.com/100/100?filter=greyscale"/&gt;</x-codeline>
                        .
                    </li>
                </ol>
            </div>
        ...
        <div class="flex flex-col md:flex-row mt-2">
            ...
            <div class="basis-full md:basis-1/2 mx-2">
                <ol>
                    <li>1.
                        <x-codeline>&lt;img src="//placephant.com/sepia/300/150"/&gt;</x-codeline>
                        .
                    </li>
                    <li>2.
                        <x-codeline>&lt;img src="//placephant.com/300/150?filter=sepia"/&gt;</x-codeline>
                        .
                    </li>
                </ol>
            </div>
        ...
        <div class="flex flex-col md:flex-row mt-2">
            ...
            <div class="basis-full md:basis-1/2 mx-2">
                <ol>
                    <li>
                        <x-codeline>&lt;img src="//placephant.com/250/0"/&gt;</x-codeline>
                        .
                    </li>
                </ol>
            </div>
        ...
        <div class="flex flex-col md:flex-row mt-2">
            ...
            <div class="basis-full md:basis-1/2 mx-2">
                <ol>
                    <li>
                        <x-codeline>&lt;img src="//placephant.com/300/200?fit=fill"/&gt;</x-codeline>
                        .
                    </li>
                </ol>
            </div>
        ...
        <div class="flex flex-col md:flex-row mt-2">
            ...
            <div class="basis-full md:basis-1/2 mx-2">
                <ol>
                    <li>
                        <x-codeline>&lt;img src="//placephant.com/310/200?fit=stretch"/&gt;</x-codeline>
                        .
                    </li>
                </ol>
            </div>
        ...
        <div class="flex flex-col md:flex-row mt-2">
            ...
            <div class="basis-full md:basis-1/2 mx-2">
                <ol>
                    <li>
                        <x-codeline>&lt;img src="//placephant.com/320/200?fit=contain"/&gt;</x-codeline>
                        .
                    </li>
                </ol>
            </div>
